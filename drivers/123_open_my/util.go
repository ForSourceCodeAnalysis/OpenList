...
func (d *Open123my) Request(url, method string, callback base.ReqCallback, resp IOpen123Resp) ([]byte, error) {
...
func (d *Open123my) flushAccessToken() error {
	// 第三方授权应用刷新token
	if d.RefreshToken != "" {
		r := &RefreshTokenResp{}
...
func (d *Open123my) SignURL(originURL, privateKey string, uid uint64, validDuration time.Duration) (newURL string, err error) {
	// 生成Unix时间戳
...
func (d *Open123my) getUserInfo(ctx context.Context) (*UserInfoResp, error) {
	var resp UserInfoResp

	if _, err := d.Request(baseURL+userInfoAPI, http.MethodGet, func(req *resty.Request) {
		req.SetContext(ctx)
	}, &resp); err != nil {
		return nil, err
	}
...
func (d *Open123my) getUID(ctx context.Context) (uint64, error) {
	if d.UID != 0 {
		return d.UID, nil
	}
	...
	d.UID = uint64(resp.Data.UID)
	return d.UID, nil
}

func (d *Open123my) getFiles(parentFileId int64, limit int, lastFileId int64) (*FileListInfo, error) {
...
func (d *Open123my) getDownloadInfo(fileID int64) (*DownloadInfo, error) {
	resp := DownloadResp{}
...
func (d *Open123my) getDirectLink(fileId int64) (*DirectLinkResp, error) {
	var resp DirectLinkResp

	_, err := d.Request(baseURL+dlURLAPI, http.MethodGet, func(req *resty.Request) {
		req.SetQueryParams(map[string]string{
			"fileID": strconv.FormatInt(fileId, 10),
		})
	}, &resp)
...
func (d *Open123my) mkdir(parentID int64, name string) error {
...
func (d *Open123my) move(fileID, toParentFileID int64) error {
...
func (d *Open123my) rename(fileID int64, fileName string) error {
...
func (d *Open123my) batchRename(renamelist []string) error {
...
func (d *Open123my) trash(fileIDs []int64) error {
...
func (d *Open123my) uploadSlice(req *UploadSliceReq) error {
...
func (d *Open123my) sliceUpComplete(uploadID string) error {
...
func (d *Open123my) getUploadServer() (string, error) {
...
func (d *Open123my) singleUpload(req *SingleUploadReq) error {
...
func (d *Open123my) uploadCreate(uc *UploadCreateReq) (*UploadCreateData, error) {
	r := &UploadCreateResp{}
